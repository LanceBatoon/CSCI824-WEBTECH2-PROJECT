...
<html>
    ...
    <body>
        ...
        <div class="memberdeal-container">
            <h2 style="padding: 20px;text-align: center;font-size: 50px;">Member Exclusive Deals</h2>
            <div class="productsd" id="products">
                <?php
                    $member = $_SESSION['userinfo'][0]['member'];
                    $sql = "SELECT * FROM product WHERE member_discount != 0";
                    global $conn;
                    $result = $conn->query($sql);
                    while($row = $result->fetch_assoc()) {
        ...
        <script>
            ...
            document.body.addEventListener("click", function(event) {
                if (event.target.classList.contains("deletecartbtn")) {
                    ...
                    cartdelete.open("POST", "membership.php", true);
                    ...
                    cartdelete.onload = function () {
                        ...
                        cart.open("POST", "membership.php", true);
                        ...
                        cqty.open("POST", "membership.php", true);
            ...
            document.body.addEventListener("click", function(event) {
                if (event.target.classList.contains("addcartbtn")) {
                    ...
                    cartadd.open("POST", "membership.php", true);
